...
namespace Drupal\commerce_currency_resolver_smart_ip\Form;
 ...
 * Mapping form.
 */
class CurrencyResolveSmartIpMapping extends ConfigFormBase {
  ...
  public function getFormId(): string {
    return 'commerce_currency_resolver_smart_ip_currency_mapping';
  }
  ...
  protected function getEditableConfigNames(): array {
    return ['commerce_currency_resolver_smart_ip.currency_mapping'];
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state): array {
    ...
    $config = $this->config('commerce_currency_resolver_smart_ip.currency_mapping');
    ...
    switch ($logic) {
      ...
      case 'currency':
        ...
        foreach ($active_currencies as $key => $currency) {
          $form['matrix'][$key] = [
            '#type' => 'textfield',
            '#autocomplete_route_name' => 'commerce_currency_resolver_smart_ip.countries.autocomplete',
